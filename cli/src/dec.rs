...
impl Decoder {
    pub fn new(transport: Transport) -> Self {
        let handle = match transport {
            Transport::Raw => unsafe { sys::aacDecoder_Open(sys::TRANSPORT_TYPE_TT_MP4_RAW, 1) },
    ...
    pub fn fill(&mut self, data: &[u8]) -> Result<usize, DecoderError> {
        unsafe {
            ...
            // println!("valid pre-fill:  {}", bytes_valid);
            ...
            // println!("valid post-fill: {}", bytes_valid);
